...
| Package                                                                                                 | Pub                                                                                                    |
|---------------------------------------------------------------------------------------------------------| ------------------------------------------------------------------------------------------------------ |
| [bloc_form](https://github.com/dukanitech/bloc_form/tree/main/packages/bloc_form_plus)                  | [![pub package](https://img.shields.io/pub/v/bloc_form.svg)](https://pub.dev/packages/bloc_form)                 |
| [flutter_bloc_form](https://github.com/duckaniteck/bloc_form/tree/main/packages/flutter_bloc_form_plus) | [![pub package](https://img.shields.io/pub/v/flutter_bloc_form.svg)](https://pub.dev/packages/flutter_bloc_form)
