...
export 'package:flutter_bloc_form_plus/src/flutter_typeahead.dart'
...
class TextFieldBlocBuilder extends StatefulWidget {
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.fieldBloc}
  /// The `fieldBloc` for rebuild the widget
  /// when its state changes.
  /// {@endtemplate}
  final TextFieldBloc<dynamic> textFieldBloc;

  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.errorBuilder}
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.enableOnlyWhenFormBlocCanSubmit}
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.isEnabled}
  ///  If false the text field is "disabled": it ignores taps
  /// and its [decoration] is rendered in grey.
  /// {@endtemplate}
  final bool isEnabled;

  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.padding}
  /// The amount of space by which to inset the child.
  /// {@endtemplate}
  final EdgeInsetsGeometry? padding;

  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.nextFocusNode}
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.textStyle}
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.textColor}
  ...
  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.animateWhenCanShow}
  /// Set to `true` if you want animate size/fade, when the
  /// field bloc is added and removed from form bloc.
  /// {@endtemplate}
  final bool animateWhenCanShow;

  /// {@template flutter_bloc_form_plus.FieldBlocBuilder.focusOnValidationFailed}
