...
import 'package:flutter_bloc_form/src/flutter_typeahead.dart';
import 'package:flutter_bloc_form/src/theme/field_theme_resolver.dart';
...
export 'package:flutter_bloc_form/src/flutter_typeahead.dart'
...
class TextFieldBlocBuilder extends StatefulWidget {
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.fieldBloc}
  /// The `fieldBloc` for rebuild the widget
  /// when its state changes.
  /// {@endtemplate}
  final TextFieldBloc<dynamic> textFieldBloc;

  /// {@template flutter_bloc_form.FieldBlocBuilder.errorBuilder}
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.enableOnlyWhenFormBlocCanSubmit}
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.isEnabled}
  ///  If false the text field is "disabled": it ignores taps
  /// and its [decoration] is rendered in grey.
  /// {@endtemplate}
  final bool isEnabled;

  /// {@template flutter_bloc_form.FieldBlocBuilder.padding}
  /// The amount of space by which to inset the child.
  /// {@endtemplate}
  final EdgeInsetsGeometry? padding;

  /// {@template flutter_bloc_form.FieldBlocBuilder.nextFocusNode}
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.textStyle}
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.textColor}
  ...
  /// {@template flutter_bloc_form.FieldBlocBuilder.animateWhenCanShow}
  /// Set to `true` if you want animate size/fade, when the
  /// field bloc is added and removed from form bloc.
  /// {@endtemplate}
  final bool animateWhenCanShow;

  /// {@template flutter_bloc_form.FieldBlocBuilder.focusOnValidationFailed}
