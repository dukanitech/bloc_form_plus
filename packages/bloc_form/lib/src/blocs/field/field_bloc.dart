...
import 'package:bloc_form/src/blocs/field/field_bloc_utils.dart';
import 'package:bloc_form/src/blocs/form/bloc_form.dart';
import 'package:bloc_form/src/extension/extension.dart';
import 'package:bloc_form/src/utils.dart';
...
part '../form/bloc_form_utils.dart';
...
mixin FieldBloc<State extends FieldBlocStateBase> on BlocBase<State> {
  ...
  /// {@template bloc_form.FieldBloc.validate}
  ...
  /// {@template bloc_form.FieldBloc.updateFormBloc}
  ...
  /// {@template bloc_form.FieldBloc.removeFormBloc}
...
abstract class SingleFieldBloc<
  ...
  */
  ...
  ///
  /// {@macro bloc_form.field_bloc.update_value}
  ...
  /// {@template bloc_form.FieldBloc.updateExtraData}
  ...
  /// {@macro bloc_form.FieldBloc.updateFormBloc}
  ...
  /// {@macro bloc_form.FieldBloc.removeFormBloc}
  ...
  /// {@template bloc_form.field_bloc.itemsWithoutDuplicates}
  ///
...
class MultiFieldBloc<ExtraData, TState extends MultiFieldBlocState<ExtraData>>
  ...
  /// {@macro bloc_form.FieldBloc.updateExtraData}
